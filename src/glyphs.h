#ifndef GLYPH_oneLedger_logo_BPP
        #define GLYPH_oneLedger_logo_WIDTH 16
        #define GLYPH_oneLedger_logo_HEIGHT 16
        #define GLYPH_oneLedger_logo_BPP 1
extern unsigned int const C_oneLedger_logo_colors[];
extern unsigned char const C_oneLedger_logo_bitmap[];
#ifdef OS_IO_SEPROXYHAL
        #include "os_io_seproxyhal.h"
        extern const bagl_icon_details_t C_oneLedger_logo;
        #endif // GLYPH_oneLedger_logo_BPP
