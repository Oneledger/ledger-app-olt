#include "glyphs.h"
unsigned int const C_oneLedger_logo_colors[] = {
  0x00000000,
  0x00ffffff,
};

unsigned char const C_oneLedger_logo_bitmap[] = {
    0xff, 0xff,
    0xcf, 0xf3,
    0x87, 0xe1,
    0x03, 0xc0,
    ...
    0xff, 0xff,
        ...
        const bagl_icon_details_t C_oneLedger_logo = { GLYPH_oneLedger_logo_WIDTH, GLYPH_oneLedger_logo_HEIGHT, 1, C_oneLedger_logo_colors, C_oneLedger_logo_bitmap };
